...
import { resourceLibrarySearchEngine } from '../../scripts/resource-library/resourceDocEngine.js';
...
} from '../../scripts/resource-library/resource-library-controller/resourceDocController.js';
...
async function readBlockProperties(block) {
  ...
  if (resp.ok) {
    ...
    main.innerHTML = html;
    const sections = Array.from(main.querySelector('.resource-library').children);
    block.textContent = '';
...
export default async function decorate(block) {
  ...
  try {
    ...
    await initializeSerachInterface(block, 'resource-librarys-search');
